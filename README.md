...
**Level**: Beginner  
**Database**: `retail_sale_analysis_SQL`
...
- **Database Creation**: The project starts by creating a database named `retail_sale_analysis_SQL`.
...
```sql
CREATE DATABASE retail_sale_analysis_SQL;
